...
require.scopes["filterComposer"] = (function()
{
  ...
  var _tempVar0 = require("url");
  var extractHostFromFrame = _tempVar0.extractHostFromFrame;
  var stringifyURL = _tempVar0.stringifyURL;
  var isThirdParty = _tempVar0.isThirdParty;
  var _tempVar1 = require("whitelisting");
  var getKey = _tempVar1.getKey;
  var checkWhitelisted = _tempVar1.checkWhitelisted;
  ...
  function composeFilters(details)
  {
    ...
    if (!checkWhitelisted(page, frame))
    {
      ...
      for (var _loopIndex2 = 0; _loopIndex2 < details.urls.length; ++_loopIndex2)
      {
        var url = details.urls[_loopIndex2];
      ...
      if (filters.length == 0 && !checkWhitelisted(page, frame, RegExpFilter.typeMap.ELEMHIDE))
      {
        ...
        for (var _loopIndex3 = 0; _loopIndex3 < selectors.length; ++_loopIndex3)
        {
          var selector = selectors[_loopIndex3];
...
{
  var exports = {};
  var _tempVar5 = require("filterClasses");
  var Filter = _tempVar5.Filter;
  var InvalidFilter = _tempVar5.InvalidFilter;
  var ElemHideBase = _tempVar5.ElemHideBase;
  ...
  exports.parseFilters = function(text)
  {
    ...
    {
      var _tempVar6 = parseFilter(lines[i]);
      var filter = _tempVar6.filter;
      var error = _tempVar6.error;
      if (filter)
      {
        filters.push(filter);
      }
...
require.scopes["icon"] = (function()
{
  ...
  function renderFrames(notificationType)
  {
    ...
    return Promise.all([loadImage("icons/abp-16.png"), loadImage("icons/abp-16-whitelisted.png"), loadImage("icons/abp-16-notification-" + notificationType + ".png"), loadImage("icons/abp-19.png"), loadImage("icons/abp-19-whitelisted.png"), loadImage("icons/abp-19-notification-" + notificationType + ".png"), loadImage("icons/abp-20.png"), loadImage("icons/abp-20-whitelisted.png"), loadImage("icons/abp-20-notification-" + notificationType + ".png"), loadImage("icons/abp-32.png"), loadImage("icons/abp-32-whitelisted.png"), loadImage("icons/abp-32-notification-" + notificationType + ".png"), loadImage("icons/abp-38.png"), loadImage("icons/abp-38-whitelisted.png"), loadImage("icons/abp-38-notification-" + notificationType + ".png"), loadImage("icons/abp-40.png"), loadImage("icons/abp-40-whitelisted.png"), loadImage("icons/abp-40-notification-" + notificationType + ".png")]).then(function(images)
    {
      ...
      for (var _loopIndex7 = 0; _loopIndex7 < [false, true].length; ++_loopIndex7)
      {
        var whitelisted = [false, true][_loopIndex7];
...
require.scopes["io"] = (function()
{
  ...
  exports.IO = {
    ...
    readFromFile: function(file, listener, callback)
    {
      ...
      {
        for (var _loopIndex10 = 0; _loopIndex10 < entry.content.length; ++_loopIndex10)
        {
          var line = entry.content[_loopIndex10];
...
require.scopes["messaging"] = (function()
{
  ...
  Port.prototype = {
    _onMessage: function(message, sender, sendResponse)
    {
      ...
      for (var _loopIndex11 = 0; _loopIndex11 < callbacks.length; ++_loopIndex11)
      {
        var callback = callbacks[_loopIndex11];
...
{
  var exports = {};
  var _tempVar12 = require("icon");
  var startIconAnimation = _tempVar12.startIconAnimation;
  var stopIconAnimation = _tempVar12.stopIconAnimation;
  var Utils = require("utils").Utils;
  ...
  function openNotificationLinks()
  {
    ...
    {
      for (var _loopIndex13 = 0; _loopIndex13 < activeNotification.links.length; ++_loopIndex13)
      {
        var link = activeNotification.links[_loopIndex13];
...
require.scopes["punycode"] = (function()
{
  ...
  var encode = function(input)
  {
    ...
    var delta = 0;
    var bias = initialBias;
    for (var _loopIndex14 = 0; _loopIndex14 < input.length; ++_loopIndex14)
    {
      var currentValue = input[_loopIndex14];
      if (currentValue < 128)
      {
    ...
    {
      var m = maxInt;
      for (var _loopIndex15 = 0; _loopIndex15 < input.length; ++_loopIndex15)
      {
        var currentValue = input[_loopIndex15];
      ...
      n = m;
      for (var _loopIndex16 = 0; _loopIndex16 < input.length; ++_loopIndex16)
      {
        var currentValue = input[_loopIndex16];
...
require.scopes["requestBlocker"] = (function()
{
  "use strict";
  var exports = {};
  var _tempVar17 = require("filterClasses");
  var Filter = _tempVar17.Filter;
  var RegExpFilter = _tempVar17.RegExpFilter;
  var BlockingFilter = _tempVar17.BlockingFilter;
  var Subscription = require("subscriptionClasses").Subscription;
  var defaultMatcher = require("matcher").defaultMatcher;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  var _tempVar18 = require("whitelisting");
  var checkWhitelisted = _tempVar18.checkWhitelisted;
  var getKey = _tempVar18.getKey;
  ...
  port.on("filters.collapse", function(message, sender)
  {
    ...
    for (var _loopIndex20 = 0; _loopIndex20 < message.urls.length; ++_loopIndex20)
    {
      var url = message.urls[_loopIndex20];
...
require.scopes["subscriptionInit"] = (function()
{
  "use strict";
  var exports = {};
  var _tempVar21 = require("subscriptionClasses");
  var Subscription = _tempVar21.Subscription;
  var DownloadableSubscription = _tempVar21.DownloadableSubscription;
  var SpecialSubscription = _tempVar21.SpecialSubscription;
  ...
  {
    for (var _loopIndex22 = 0; _loopIndex22 < FilterStorage.subscriptions.length; ++_loopIndex22)
    {
      var subscription = FilterStorage.subscriptions[_loopIndex22];
  ...
  {
    var subscriptions = [];
    for (var _loopIndex23 = 0; _loopIndex23 < Prefs.additional_subscriptions.length; ++_loopIndex23)
    {
      var url = Prefs.additional_subscriptions[_loopIndex23];
  ...
  function finishInitialization(subscriptions)
  {
    ...
    for (var _loopIndex24 = 0; _loopIndex24 < subscriptions.length; ++_loopIndex24)
    {
      var subscription = subscriptions[_loopIndex24];
...
require.scopes["whitelisting"] = (function()
{
  ...
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var _tempVar25 = require("url");
  var stringifyURL = _tempVar25.stringifyURL;
  var getDecodedHostname = _tempVar25.getDecodedHostname;
  var extractHostFromFrame = _tempVar25.extractHostFromFrame;
  var isThirdParty = _tempVar25.isThirdParty;
  var port = require("messaging").port;
  var devtools = require("devtools");
  ...
  FilterNotifier.on("filter.behaviorChanged", function()
  {
    ...
    {}, function(pages)
    {
      for (var _loopIndex26 = 0; _loopIndex26 < pages.length; ++_loopIndex26)
      {
        var page = pages[_loopIndex26];
  ...
  function onHeadersReceived(details)
  {
    ...
    for (var _loopIndex27 = 0; _loopIndex27 < details.responseHeaders.length; ++_loopIndex27)
    {
      var header = details.responseHeaders[_loopIndex27];
...
require.scopes["antiadblockInit"] = (function()
{
  ...
  exports.initAntiAdblockNotification = function initAntiAdblockNotification()
  {
    ...
    {
      var urlFilters = [];
      for (var _loopIndex29 = 0; _loopIndex29 < subscription.filters.length; ++_loopIndex29)
      {
        var filter = subscription.filters[_loopIndex29];
...
require.scopes["cssRules"] = (function()
{
  ...
  var CSSRules = exports.CSSRules = {
    ...
    getRulesForDomain: function(domain)
    {
      ...
      for (var _loopIndex30 = 0; _loopIndex30 < keys.length; ++_loopIndex30)
      {
        var key = keys[_loopIndex30];
...
require.scopes["downloader"] = (function()
{
  ...
  Downloader.prototype = {
    ...
    {
      var now = Date.now();
      for (var _loopIndex31 = 0; _loopIndex31 < this.dataSource().length; ++_loopIndex31)
      {
        var downloadable = this.dataSource()[_loopIndex31];
    ...
    {
      var _tempVar32 = require("info");
      var addonName = _tempVar32.addonName;
      var addonVersion = _tempVar32.addonVersion;
      var application = _tempVar32.application;
      var applicationVersion = _tempVar32.applicationVersion;
      var platform = _tempVar32.platform;
      var platformVersion = _tempVar32.platformVersion;
  ...
  var ElemHide = exports.ElemHide = {
    ...
    add: function(filter)
    {
      if (filter instanceof ElemHideException)
      {
        ...
        if (filterKeys)
        {
          for (var _loopIndex33 = 0; _loopIndex33 < filterKeys.length; ++_loopIndex33)
          {
            var filterKey = filterKeys[_loopIndex33];
    ...
    getUnconditionalFilterKeys: function()
    {
      if (!unconditionalFilterKeys)
      {
        ...
        for (var _loopIndex34 = 0; _loopIndex34 < selectors.length; ++_loopIndex34)
        {
          var selector = selectors[_loopIndex34];
...
require.scopes["events"] = (function()
{
  ...
  exports.EventEmitter.prototype = {
    ...
    emit: function(name)
    {
      ...
      for (var _loopIndex35 = 0; _loopIndex35 < listeners.length; ++_loopIndex35)
      {
        var listener = listeners[_loopIndex35];
...
require.scopes["filterClasses"] = (function()
{
  ...
  Filter.normalize = function(text)
  {
    ...
    {
      var _tempVar36 = /^(.*?)(#\@?#?)(.*)$/.exec(text);
      var domain = _tempVar36[1];
      var separator = _tempVar36[2];
      var selector = _tempVar36[3];
  ...
  RegExpFilter.fromText = function(text)
  {
    ...
    if (match)
    {
      ...
      for (var _loopIndex37 = 0; _loopIndex37 < options.length; ++_loopIndex37)
      {
        var option = options[_loopIndex37];
        var value = null;
  ...
  ElemHideBase.fromText = function(text, domain, isException, tagName, attrRules, selector)
  {
    if (!selector)
    {
      ...
      if (attrRules)
      {
        ...
        for (var _loopIndex38 = 0; _loopIndex38 < attrRules.length; ++_loopIndex38)
        {
          var rule = attrRules[_loopIndex38];
...
require.scopes["filterListener"] = (function()
{
  ...
  var RegExpFilter = _tempVar39.RegExpFilter;
  var ElemHideBase = _tempVar39.ElemHideBase;
  var CSSPropertyFilter = _tempVar39.CSSPropertyFilter;
  var Prefs = require("prefs").Prefs;
  var isDirty = 0;
  var FilterListener = {
...
require.scopes["filterStorage"] = (function()
{
  ...
  var Prefs = require("prefs").Prefs;
  var _tempVar41 = require("filterClasses");
  var Filter = _tempVar41.Filter;
  var ActiveFilter = _tempVar41.ActiveFilter;
  var _tempVar42 = require("subscriptionClasses");
  var Subscription = _tempVar42.Subscription;
  var SpecialSubscription = _tempVar42.SpecialSubscription;
  var ExternalSubscription = _tempVar42.ExternalSubscription;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Utils = require("utils").Utils;
  var formatVersion = 4;
  var FilterStorage = exports.FilterStorage = {
    ...
    resetHitCounts: function(filters)
    {
      ...
      for (var _loopIndex44 = 0; _loopIndex44 < filters.length; ++_loopIndex44)
      {
        var filter = filters[_loopIndex44];
        filter.hitCount = 0;
        filter.lastHit = 0;
      }
    },
      ...
      var readFile = function(sourceFile, backupIndex)
      {
        ...
        IO.readFromFile(sourceFile, parser, function(e)
        {
          ...
          if (e && !explicitFile)
          {
            ...
            if (sourceFile)
            {
              var _tempVar45 = /^(.*)(\.\w+)$/.exec(sourceFile.leafName) || [null, sourceFile.leafName, ""];
    ...
    {
      var _generatorResult46 = [];
      _generatorResult46.push("# Adblock Plus preferences");
      _generatorResult46.push("version=" + formatVersion);
      ...
      var checkBackupRequired = function(callbackNotRequired, callbackRequired)
      {
        ...
        else
        {
          IO.statFile(targetFile, function(e, statData)
          {
            ...
            {
              var _tempVar47 = /^(.*)(\.\w+)$/.exec(targetFile.leafName) || [null, targetFile.leafName, ""];
              var part1 = _tempVar47[1];
              var part2 = _tempVar47[2];
    ...
    {
      var result = [];
      var _tempVar48 = /^(.*)(\.\w+)$/.exec(FilterStorage.sourceFile.leafName) || [null, FilterStorage.sourceFile.leafName, ""];
  ...
  function removeSubscriptionFilters(subscription)
  {
    ...
    for (var _loopIndex50 = 0; _loopIndex50 < subscription.filters.length; ++_loopIndex50)
    {
      var filter = subscription.filters[_loopIndex50];
          ...
          if (this.curObj)
          {
            ...
            case "subscription patterns":
              if (this.subscriptions.length)
              {
                ...
                for (var _loopIndex51 = 0; _loopIndex51 < this.curObj.length; ++_loopIndex51)
                {
                  var text = this.curObj[_loopIndex51];
...
require.scopes["notification"] = (function()
{
  var exports = {};
  var Prefs = require("prefs").Prefs;
  var _tempVar53 = require("downloader");
  var Downloader = _tempVar53.Downloader;
  var Downloadable = _tempVar53.Downloadable;
  var MILLIS_IN_MINUTE = _tempVar53.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar53.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar53.MILLIS_IN_DAY;
  var Utils = require("utils").Utils;
  var _tempVar54 = require("matcher");
  var Matcher = _tempVar54.Matcher;
  var defaultMatcher = _tempVar54.defaultMatcher;
  var _tempVar55 = require("filterClasses");
  var Filter = _tempVar55.Filter;
  var RegExpFilter = _tempVar55.RegExpFilter;
  var WhitelistFilter = _tempVar55.WhitelistFilter;
  ...
  var Notification = exports.Notification = {
    ...
    _getDownloadables: function()
    {
      ...
      _generatorResult46.push(downloadable);
      return _generatorResult46;
    },
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      try
      {
        ...
        for (var _loopIndex56 = 0; _loopIndex56 < data.notifications.length; ++_loopIndex56)
        {
          var notification = data.notifications[_loopIndex56];
      ...
      var _tempVar57 = downloader.processExpirationInterval(EXPIRATION_INTERVAL);
      Prefs.notificationdata.softExpiration = _tempVar57[0];
      Prefs.notificationdata.hardExpiration = _tempVar57[1];
    ...
    _getNextToShow: function(url)
    {
      ...
      var _tempVar58 = require("info");
      var addonName = _tempVar58.addonName;
      var addonVersion = _tempVar58.addonVersion;
      var application = _tempVar58.application;
      var applicationVersion = _tempVar58.applicationVersion;
      var platform = _tempVar58.platform;
      var platformVersion = _tempVar58.platformVersion;
      var notificationToShow = null;
      for (var _loopIndex59 = 0; _loopIndex59 < notifications.length; ++_loopIndex59)
      {
        var notification = notifications[_loopIndex59];
        ...
        if (typeof url === "string" || notification.urlFilters instanceof Array)
        {
          if (Prefs.enabled && typeof url === "string" && notification.urlFilters instanceof Array)
          {
            ...
            for (var _loopIndex60 = 0; _loopIndex60 < notification.urlFilters.length; ++_loopIndex60)
            {
              var urlFilter = notification.urlFilters[_loopIndex60];
        ...
        {
          var match = false;
          for (var _loopIndex61 = 0; _loopIndex61 < notification.targets.length; ++_loopIndex61)
          {
            var target = notification.targets[_loopIndex61];
    ...
    showNext: function(url)
    {
      ...
      if (notification)
      {
        for (var _loopIndex62 = 0; _loopIndex62 < showListeners.length; ++_loopIndex62)
        {
          var showListener = showListeners[_loopIndex62];
    ...
    getLocalizedTexts: function(notification, locale)
    {
      ...
      var localizedTexts = [];
      for (var _loopIndex63 = 0; _loopIndex63 < textKeys.length; ++_loopIndex63)
      {
        var key = textKeys[_loopIndex63];
    ...
    triggerQuestionListeners: function(id, approved)
    {
      ...
      for (var _loopIndex64 = 0; _loopIndex64 < listeners.length; ++_loopIndex64)
      {
        var listener = listeners[_loopIndex64];
        listener(approved);
      }
    },
...
require.scopes["subscriptionClasses"] = (function()
{
  ...
  var ActiveFilter = _tempVar65.ActiveFilter;
  var BlockingFilter = _tempVar65.BlockingFilter;
  var WhitelistFilter = _tempVar65.WhitelistFilter;
  var ElemHideBase = _tempVar65.ElemHideBase;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var _tempVar66 = require("coreUtils");
  var desc = _tempVar66.desc;
  var extend = _tempVar66.extend;
  ...
  Subscription.prototype = {
    ...
    {
      for (var _loopIndex67 = 0; _loopIndex67 < this.filters.length; ++_loopIndex67)
      {
        var filter = this.filters[_loopIndex67];
  ...
  SpecialSubscription.prototype = extend(Subscription,
  {
    ...
    isDefaultFor: function(filter)
    {
      ...
      {
        for (var _loopIndex68 = 0; _loopIndex68 < this.defaults.length; ++_loopIndex68)
        {
          var type = this.defaults[_loopIndex68];
...
{
  var exports = {};
  var _tempVar69 = require("downloader");
  var Downloader = _tempVar69.Downloader;
  var Downloadable = _tempVar69.Downloadable;
  var MILLIS_IN_SECOND = _tempVar69.MILLIS_IN_SECOND;
  var MILLIS_IN_MINUTE = _tempVar69.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar69.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar69.MILLIS_IN_DAY;
  var _tempVar70 = require("filterClasses");
  var Filter = _tempVar70.Filter;
  var CommentFilter = _tempVar70.CommentFilter;
  var FilterStorage = require("filterStorage").FilterStorage;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  var _tempVar71 = require("subscriptionClasses");
  var Subscription = _tempVar71.Subscription;
  var DownloadableSubscription = _tempVar71.DownloadableSubscription;
  var Utils = require("utils").Utils;
  var INITIAL_DELAY = 1 * MILLIS_IN_MINUTE;
  var CHECK_INTERVAL = 1 * MILLIS_IN_HOUR;
  ...
  var Synchronizer = exports.Synchronizer = {
    ...
    _getDownloadables: function()
    {
      ...
      for (var _loopIndex72 = 0; _loopIndex72 < FilterStorage.subscriptions.length; ++_loopIndex72)
      {
        ...
        {
          _generatorResult46.push(this._getDownloadable(subscription, false));
        }
      }
      return _generatorResult46;
    },
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      ...
      var _tempVar73 = downloader.processExpirationInterval(expirationInterval);
      var softExpiration = _tempVar73[0];
      var hardExpiration = _tempVar73[1];
      ...
      lines.shift();
      var filters = [];
      for (var _loopIndex74 = 0; _loopIndex74 < lines.length; ++_loopIndex74)
      {
        var line = lines[_loopIndex74];
...
require.scopes["devtools"] = (function()
{
  "use strict";
  var exports = {};
  var _tempVar75 = require("filterClasses");
  var RegExpFilter = _tempVar75.RegExpFilter;
  var WhitelistFilter = _tempVar75.WhitelistFilter;
  var ElemHideFilter = _tempVar75.ElemHideFilter;
  ...
  function getFilterInfo(filter)
  {
    ...
    for (var _loopIndex76 = 0; _loopIndex76 < filter.subscriptions.length; ++_loopIndex76)
    {
      var subscription = filter.subscriptions[_loopIndex76];
      if (!subscription.disabled)
      {
        if (subscription instanceof SpecialSubscription)
        {
  ...
  function logHiddenElements(page, selectors, docDomain)
  {
    var panel = getActivePanel(page);
    {
      for (var _loopIndex77 = 0; _loopIndex77 < FilterStorage.subscriptions.length; ++_loopIndex77)
      {
        var subscription = FilterStorage.subscriptions[_loopIndex77];
        if (subscription.disabled)
        {
          continue;
        }
        for (var _loopIndex78 = 0; _loopIndex78 < subscription.filters.length; ++_loopIndex78)
        {
          var filter = subscription.filters[_loopIndex78];
  ...
  exports.logWhitelistedDocument = function(page, url, typeMask, docDomain, filter)
  {
    ...
    if (panel)
    {
      for (var _loopIndex79 = 0; _loopIndex79 < nonRequestTypes.length; ++_loopIndex79)
      {
        var type = nonRequestTypes[_loopIndex79];
...
require.scopes["popupBlocker"] = (function()
{
  ...
  var defaultMatcher = require("matcher").defaultMatcher;
  var BlockingFilter = require("filterClasses").BlockingFilter;
  var _tempVar80 = require("url");
  var stringifyURL = _tempVar80.stringifyURL;
  var isThirdParty = _tempVar80.isThirdParty;
  var extractHostFromFrame = _tempVar80.extractHostFromFrame;
...
require.scopes["uninstall"] = (function()
{
  ...
  function setUninstallURL()
  {
    ...
    for (var _loopIndex81 = 0; _loopIndex81 < keys.length; ++_loopIndex81)
    {
      var key = keys[_loopIndex81];
...
require.scopes["csp"] = (function()
{
  ...
  var exports = {};
  var defaultMatcher = require("matcher").defaultMatcher;
  var _tempVar82 = require("filterClasses");
  var BlockingFilter = _tempVar82.BlockingFilter;
  var RegExpFilter = _tempVar82.RegExpFilter;
...
// require("uninstall");
// require("csp");
const adblockplus = Object.assign({},
